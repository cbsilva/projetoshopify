...
FOR EACH tt_epc NO-LOCK:
   ...
   IF AVAIL item_lote_impl_tit_acr THEN DO:       
      ...
      IF AVAILABLE nota-fiscal THEN DO:
            ...
            FIND FIRST es-ped-venda-spf
                 where es-ped-venda-spf.nome-abrev = nota-fiscal.nome-ab-cli
                   and es-ped-venda-spf.nr-pedcli  = nota-fiscal.nr-pedcli no-lock no-error.
            
            IF AVAIL es-ped-venda-spf THEN DO:
            
                FIND FIRST es-api-param-acr-spf 
                     WHERE es-api-param-acr-spf.cod_empresa = i-ep-codigo-usuario
                       AND es-api-param-acr-spf.cod_estab   = item_lote_impl_tit_acr.cod_estab no-lock no-error.
                ...
                IF AVAIL lote_impl_tit_acr THEN DO:
                    ...
                    IF AVAIL ES-PED-VENDA-SPF THEN
                        lote_impl_tit_acr.dat_transacao  = es-ped-venda-spf.dt-pagamento.
                ...
                IF AVAIL es-api-param-acr-spf THEN
                    ASSIGN item_lote_impl_tit_acr.cod_cart_bcia   = es-api-param-acr-spf.cod_cart_bcia
                           item_lote_impl_tit_acr.cod_espec_docto = es-api-param-acr-spf.cod_espec_docto
                           item_lote_impl_tit_acr.cod_portador    = es-api-param-acr-spf.COD_PORTADOR
                           item_lote_impl_tit_acr.cod_ser_docto   = es-api-param-acr-spf.cod_ser_docto.
