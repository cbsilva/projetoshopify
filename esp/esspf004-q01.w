...
*******************************************************************************/
{include/i-prgvrs.i esspf004-Q01 2.09.00.000}
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH es-api-param-spf NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH es-api-param-spf NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main es-api-param-spf
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main es-api-param-spf
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "mgcam.es-api-param-spf"
     _Options          = "NO-LOCK"
