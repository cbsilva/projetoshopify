...
DO:
    ...
    RUN esp/esint301.p(INPUT pRowid, INPUT 17006, INPUT pErro). 
    RETURN "NOK":U.
END.
...
COPY-LOB FROM OBJECT  es-api-import.c-json TO mJson.
 
LOG-MANAGER:WRITE-MESSAGE("COPIANDO MEMPTR PARA LONGCHAR").

COPY-LOB FROM OBJECT mJson TO cLongJson CONVERT SOURCE CODEPAGE "iso8859-1" TARGET CODEPAGE "utf-8" NO-ERROR.  
    ...
    DO:
        ...
        DO:
            FOR EACH RowErrors NO-LOCK:
                ...
                RUN esp/esint301.p(INPUT pRowid, INPUT RowErrors.ErrorNumber, INPUT RowErrors.ErrorDescription).
            END.
            RETURN "NOK":U.
        END.
