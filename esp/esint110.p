...
DEFINE VARIABLE hProc AS HANDLE      NO-UNDO.
    ...
    COPY-LOB es-api-import.c-json TO m-json.
...
/*             :                                 */
            ...
            RUN processarDados IN hProc
                (OUTPUT pChave).
/*             MESSAGE "esint110 - depoips do processar dados " RETURN-VALUE */
...
DEFINE VARIABLE cProgramName AS CHARACTER NO-UNDO.
    ...
    DO WHILE VALID-HANDLE(hProcedureHandle):
        IF VALID-HANDLE(hProcedureHandle) AND NOT hProcedureHandle:FILE-NAME MATCHES "*esint100*" THEN
        DO:
