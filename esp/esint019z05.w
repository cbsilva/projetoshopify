...
DEFINE VARIABLE h_esint019b05 AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esint019b05.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esint019b05 ).
       RUN set-position IN h_esint019b05 ( 2.75 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 10.17 , 80.14 ) */

       /* Links to SmartBrowser h_esint019b05. */
       RUN add-link IN adm-broker-hdl ( h_esint019b05 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_esint019b05 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
