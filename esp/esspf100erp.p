...
LOG-MANAGER:WRITE-MESSAGE("In°cio Processo - esspf100EIRP - V.2.5 - MERGE LOGISTICA - Exportaá∆o").
        ...
        DO:
            ...
            FOR EACH  bf-es-api-export-spf 
                ...
                LOG-MANAGER:WRITE-MESSAGE("INI - Processando CD-TIPO-TRANS:" + STRING(bf-es-api-export-spf.cd-tipo-integr) 
                                + " Situaá∆o:" + STRING(bf-es-api-export-spf.ind-situacao)
...
/* RUN gerarLog("In°cio Processo - esspf100ERP - V.1.0 - Exportaá∆o").                                                                */
/*                                                                                                                                    */
...
/*         END.                                                                                                                       */
/*                                                                                                                                    */
/*         RUN gerarLog("Programa de integraá∆o: " + SEARCH(es-api-param-spf.programa-integr ) ).                                         */
/*                                                                                                                                    */
/*                                                                                                                                    */
