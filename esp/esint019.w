...
*******************************************************************************/
{include/i-prgvrs.i esint019 9.99.99.999}
...
DEFINE VARIABLE h_esint019q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_esint019v01-2 AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esint019v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esint019v01-2 ).
       RUN set-position IN h_esint019v01-2 ( 3.25 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 17.50 , 101.72 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esint019q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'ProgPesquisa = esp/esint019z01.w,
                     ProgVaPara = esp/esint019g01.w,
                     ProgIncMod = ,
                     Implantar = no':U ,
             OUTPUT h_esint019q01 ).
       RUN set-position IN h_esint019q01 ( 1.25 , 67.29 ) NO-ERROR.
       /* Size in UIB:  ( 1.50 , 8.29 ) */

       /* Links to SmartPanel h_p-exihel. */
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'State':U , h_p-exihel ).

       /* Links to SmartViewer h_esint019v01-2. */
       RUN add-link IN adm-broker-hdl ( h_esint019q01 , 'Record':U , h_esint019v01-2 ).
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'TableIO':U , h_esint019v01-2 ).

       /* Links to SmartQuery h_esint019q01. */
       RUN add-link IN adm-broker-hdl ( h_p-exihel , 'State':U , h_esint019q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'Navigation':U , h_esint019q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'State':U , h_esint019q01 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-exihel ,
             h_p-cadsim , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_esint019v01-2 ,
             h_p-exihel , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "esint019" "9.99.99.999"}
