...
*******************************************************************************/
{include/i-prgvrs.i esspf004 2.09.00.000}
...
/* Create an unnamed pool to store all the widgets created l
...
DEFINE VARIABLE h_esspf004-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_esspf004-v01 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
    ...
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         ...
         AT COL 1 ROW 1
         SIZE 107.57 BY 23.92 WIDGET-ID 100.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esspf004-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esspf004-v01 ).
       RUN set-position IN h_esspf004-v01 ( 3.00 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 20.25 , 106.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esspf004-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'ProgPesquisa = esp/esspf004-z01.w,
                     ProgVaPara = esp/esspf004-g01.w,
                     ProgIncMod = ,
                     Implantar = no':U ,
             OUTPUT h_esspf004-q01 ).
       RUN set-position IN h_esspf004-q01 ( 1.33 , 62.72 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartPanel h_p-exihel. */
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'State':U , h_p-exihel ).

       /* Links to SmartViewer h_esspf004-v01. */
       RUN add-link IN adm-broker-hdl ( h_esspf004-q01 , 'Record':U , h_esspf004-v01 ).
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'TableIO':U , h_esspf004-v01 ).

       /* Links to SmartQuery h_esspf004-q01. */
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'Navigation':U , h_esspf004-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'State':U , h_esspf004-q01 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-exihel ,
             h_p-cadsim , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_esspf004-v01 ,
             h_p-exihel , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "esspf004" "12.00.00.000"}
