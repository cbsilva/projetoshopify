...
&Scoped-define INTERNAL-TABLES es-api-token-param-spf

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH es-api-token-param-spf NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH es-api-token-param-spf NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main es-api-token-param-spf
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main es-api-token-param-spf
...
<FOREIGN-KEYS>
cod-usuario||y|movmac.es-api-token-param-spf.cod-usuario
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
DEFINE QUERY Query-Main FOR 
      es-api-token-param-spf SCROLLING.
&ANALYZE-RESUME
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "movmac.es-api-token-param-spf"
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "cod-usuario" "es-api-token-param-spf" "cod-usuario"}
