...
*******************************************************************************/
{include/i-prgvrs.i esspf002 12.1.10.001}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i esspf002 MCD}
&ENDIF
...
DEFINE VARIABLE h_q01esspf002 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_v01esspf002 AS HANDLE NO-UNDO.
...
ON END-ERROR OF w-cadsim /* Manuten‡Æo Canal */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-cadsim w-cadsim
ON WINDOW-CLOSE OF w-cadsim /* Manuten‡Æo Canal */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esspf002-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v01esspf002 ).
       RUN set-position IN h_v01esspf002 ( 2.83 , 1.57 ) NO-ERROR.
       /* Size in UIB:  ( 1.25 , 88.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esspf002-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'ProgPesquisa = esp/esspf002-z01.w,
                     ProgVaPara = esp/esspf002-g01.w,
                     ProgIncMod = ,
                     Implantar = no':U ,
             OUTPUT h_q01esspf002 ).
       RUN set-position IN h_q01esspf002 ( 1.25 , 61.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.50 , 6.00 ) */

       /* Links to SmartPanel h_p-exihel. */
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'State':U , h_p-exihel ).

       /* Links to SmartViewer h_v01esspf002. */
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'TableIO':U , h_v01esspf002 ).
       RUN add-link IN adm-broker-hdl ( h_q01esspf002 , 'Record':U , h_v01esspf002 ).

       /* Links to SmartQuery h_q01esspf002. */
       RUN add-link IN adm-broker-hdl ( h_p-exihel , 'State':U , h_q01esspf002 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'Navigation':U , h_q01esspf002 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'State':U , h_q01esspf002 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-exihel ,
             h_p-cadsim , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v01esspf002 ,
             h_p-exihel , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "esspf002" "12.1.10.001"}
