...
*******************************************************************************/
{include/i-prgvrs.i esspf004-B01 2.09.00.000}
...
&Scoped-define INTERNAL-TABLES es-api-param-spf

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br-table                                      */
&Scoped-define FIELDS-IN-QUERY-br-table es-api-param-spf.cd-tipo-integr es-api-param-spf.des-tipo-integr   
&Scoped-define ENABLED-FIELDS-IN-QUERY-br-table   
&Scoped-define SELF-NAME br-table
&Scoped-define QUERY-STRING-br-table FOR EACH es-api-param-spf NO-LOCK        WHERE es-api-param-spf.cd-tipo-integr >= i-inicial          AND es-api-param-spf.cd-tipo-integr <= i-final     ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-br-table OPEN QUERY {&SELF-NAME}     FOR EACH es-api-param-spf NO-LOCK        WHERE es-api-param-spf.cd-tipo-integr >= i-inicial          AND es-api-param-spf.cd-tipo-integr <= i-final     ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-br-table es-api-param-spf
&Scoped-define FIRST-TABLE-IN-QUERY-br-table es-api-param-spf
...
<FOREIGN-KEYS>
cd-sistema|y|y|mgcam.es-api-param-spf.cd-sistema
cd-tipo-integr||y|mgcam.es-api-param-spf.cd-tipo-integr
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br-table B-table-Win _FREEFORM
  QUERY br-table NO-LOCK DISPLAY
      es-api-param-spf.cd-tipo-integr  FORMAT ">,>>>,>>9":U
      es-api-param-spf.des-tipo-integr FORMAT "x(40)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
OPEN QUERY {&SELF-NAME}
    FOR EACH es-api-param-spf NO-LOCK
       WHERE es-api-param-spf.cd-tipo-integr >= i-inicial
         AND es-api-param-spf.cd-tipo-integr <= i-final
...
------------------------------------------------------------------------------*/
  ...
  CASE RETURN-VALUE:
    WHEN 'cd-sistema':U THEN DO:
       &Scope KEY-PHRASE es-api-param-spf.cd-sistema eq INTEGER(key-value)
...
------------------------------------------------------------------------------*/
    ...
    if  avail es-api-param-spf then do:
        case p-campo:
            when "cd-tipo-integr" then
                assign p-valor = string(es-api-param-spf.cd-tipo-integr).
            when "des-tipo-integr" then
                assign p-valor = string(es-api-param-spf.des-tipo-integr).
        end.
    end.
    return p-valor.
END PROCEDURE.
