...
DEFINE VARIABLE c-tipo-ped          AS CHARACTER   NO-UNDO.
...
&Scoped-define FIELDS-IN-QUERY-br-exp es-api-export-spf.id-movto es-api-param-spf.des-tipo-integr es-api-export-spf.chave es-api-export-spf.data-inicio es-api-export-spf.data-fim c-status   
...
&Scoped-define FIELDS-IN-QUERY-br-imp es-api-import-spf.id-movto es-api-param-spf.des-tipo-integr c-tipo-ped es-api-import-spf.chave es-api-import-spf.data-movto es-api-import-spf.data-inicio es-api-import-spf.data-fim c-status c-log es-api-import-spf.chave-alt   
...
&Scoped-Define ENABLED-OBJECTS bt-rel rt-button RECT-4 IMAGE-7 IMAGE-8 ~
bt-rep cb-estado cb-status fi-dt-movto-ini fi-dt-movto-fim fi-chave ~
bt-pesquisar br-imp br-exp br-log edLog 
&Scoped-Define DISPLAYED-OBJECTS cb-estado cb-status fi-dt-movto-ini ~
fi-dt-movto-fim fi-chave edLog 
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 111 BY 13.29
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br-imp w-livre _FREEFORM
  QUERY br-imp NO-LOCK DISPLAY
      ...
      es-api-param-spf.des-tipo-integr  FORMAT 'X(30)'  COLUMN-LABEL "Descriá∆o"        WIDTH 20
      c-tipo-ped                    FORMAT 'X(10)'  COLUMN-LABEL "Tp Pedido"        WIDTH 8
      es-api-import-spf.chave           FORMAT 'x(30)'  COLUMN-LABEL "Cliente / Pedido" WIDTH 30
      es-api-import-spf.data-movto                      COLUMN-LABEL "Data Transaá∆o"
      es-api-import-spf.data-inicio                     COLUMN-LABEL "Data In°cio"
      es-api-import-spf.data-fim                        COLUMN-LABEL "Data TÇrmino"
      c-status                      FORMAT 'X(20)'  COLUMN-LABEL "Status"
      c-log                         FORMAT 'X(256)'  COLUMN-LABEL "Log"
      es-api-import-spf.chave-alt       FORMAT 'X(100)'   COLUMN-LABEL "Chave Alt"       WIDTH 100
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 144 BY 13.29
...
tt-log.cd-tipo  
tt-log.nr-seq   
tt-log.c-log FORMAT "x(1000)" WIDTH 200
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 143.86 BY 4.5
         FONT 1.
...
DEFINE FRAME f-cad
     bt-rel AT ROW 1.21 COL 6.29 WIDGET-ID 24
     cb-sistema AT ROW 2.46 COL 46.72 COLON-ALIGNED WIDGET-ID 48
     bt-rep AT ROW 1.21 COL 1.86 WIDGET-ID 18
     cb-tipo-integr AT ROW 2.46 COL 83.57 COLON-ALIGNED WIDGET-ID 10
     rs-transacao AT ROW 2.58 COL 3.43 NO-LABEL WIDGET-ID 30
     cb-estado AT ROW 3 COL 6 COLON-ALIGNED WIDGET-ID 8
     cb-status AT ROW 3 COL 36 COLON-ALIGNED WIDGET-ID 12
     fi-dt-movto-ini AT ROW 3 COL 75 COLON-ALIGNED WIDGET-ID 46
     fi-dt-movto-fim AT ROW 3 COL 89.72 COLON-ALIGNED NO-LABEL WIDGET-ID 52
     fi-chave AT ROW 3 COL 109 COLON-ALIGNED WIDGET-ID 14
     bt-pesquisar AT ROW 3 COL 139 WIDGET-ID 16
     br-imp AT ROW 4.5 COL 1 WIDGET-ID 500
     br-exp AT ROW 6.29 COL 1.14 WIDGET-ID 600
     br-log AT ROW 18 COL 1.14 WIDGET-ID 300
     edLog AT ROW 22.83 COL 1 NO-LABEL WIDGET-ID 58
     " Filtros" VIEW-AS TEXT
          SIZE 8 BY .67 AT ROW 2.5 COL 3 WIDGET-ID 44
     rt-button AT ROW 1 COL 1.29
     RECT-4 AT ROW 2.63 COL 1 WIDGET-ID 38
     RECT-5 AT ROW 2.5 COL 1 WIDGET-ID 40
     IMAGE-7 AT ROW 3 COL 86.43 WIDGET-ID 54
     IMAGE-8 AT ROW 3 COL 89.29 WIDGET-ID 56
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 144.43 BY 27.92
...
/* SETTINGS FOR FRAME f-cad
   FRAME-NAME L-To-R                                                    */
/* BROWSE-TAB br-imp bt-pesquisar f-cad */
...
/* SETTINGS FOR COMBO-BOX cb-sistema IN FRAME f-cad
   NO-DISPLAY NO-ENABLE                                                 */
ASSIGN 
       cb-sistema:HIDDEN IN FRAME f-cad           = TRUE.

/* SETTINGS FOR COMBO-BOX cb-tipo-integr IN FRAME f-cad
   NO-DISPLAY NO-ENABLE                                                 */
ASSIGN 
       cb-tipo-integr:HIDDEN IN FRAME f-cad           = TRUE.

/* SETTINGS FOR RECTANGLE RECT-5 IN FRAME f-cad
   NO-ENABLE                                                            */
ASSIGN 
       RECT-5:HIDDEN IN FRAME f-cad           = TRUE.

/* SETTINGS FOR RADIO-SET rs-transacao IN FRAME f-cad
   NO-DISPLAY NO-ENABLE                                                 */
ASSIGN 
       rs-transacao:HIDDEN IN FRAME f-cad           = TRUE.
...
N∆o Integrado (Erro),2 */
    ...
    IF es-api-export-spf.cod-status = 0 THEN
        ASSIGN es-api-export-spf.id-movto           :fgcolor in browse br-exp = 1
               es-api-param-spf.des-tipo-integr     :fgcolor in browse br-exp = 1
               es-api-export-spf.chave              :fgcolor in browse br-exp = 1
               es-api-export-spf.data-inicio        :fgcolor in browse br-exp = 1
               es-api-export-spf.data-fim           :fgcolor in browse br-exp = 1
               c-status                         :fgcolor in browse br-exp = 1.   
           
    ELSE IF es-api-export-spf.cod-status = 1 THEN
         ASSIGN es-api-export-spf.id-movto          :fgcolor in browse br-exp = 9
                es-api-param-spf.des-tipo-integr    :fgcolor in browse br-exp = 9
                es-api-export-spf.chave             :fgcolor in browse br-exp = 9
                es-api-export-spf.data-inicio       :fgcolor in browse br-exp = 9
                es-api-export-spf.data-fim          :fgcolor in browse br-exp = 9
                c-status                        :fgcolor in browse br-exp = 9.
                                                
        ELSE IF es-api-export-spf.cod-status = 2 THEN
            ASSIGN es-api-export-spf.id-movto       :fgcolor in browse br-exp = 12
                   es-api-param-spf.des-tipo-integr :fgcolor in browse br-exp = 12
                   es-api-export-spf.chave          :fgcolor in browse br-exp = 12
                   es-api-export-spf.data-inicio    :fgcolor in browse br-exp = 12
                   es-api-export-spf.data-fim       :fgcolor in browse br-exp = 12
                   c-status                     :fgcolor in browse br-exp = 12.
...
DEFINE VARIABLE iCor AS INTEGER     NO-UNDO.
    ...
    ELSE IF es-api-import-spf.cod-status = 2 THEN
        ...
        ASSIGN es-api-import-spf.id-movto           :fgcolor in browse br-imp = iCor
               ...
               es-api-import-spf.chave-alt          :fgcolor in browse br-imp = iCor
            .   
...
DO:     
    ...
    ELSE DO:
        ...
        IF rs-transacao = 1 THEN DO:   
            ...
            //IF c-cb-tipo-integr = "99" THEN c-cb-tipo-integr = "". ELSE c-cb-tipo-integr  = ' AND es-api-import-spf.cd-tipo-integr = ' + c-cb-tipo-integr .
            c-cb-tipo-integr = ' AND es-api-import-spf.cd-tipo-integr = 1 OR es-api-import-spf.cd-tipo-integr = 5 ' .
...
DO:  
    ...
    IF rs-transacao = 2 THEN DO:
        IF AVAIL es-api-export-spf THEN DO:
            ...
            IF es-api-export-spf.cod-status = 2 THEN DO:
    ...
    ELSE DO:
        IF AVAIL es-api-import-spf THEN DO:
            ...
            IF es-api-import-spf.cod-status = 2 THEN DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-exihel ).
       RUN set-position IN h_p-exihel ( 1.13 , 128.72 ) NO-ERROR.
...
OCXFile = SEARCH( "esspf006b.wrx":U ).
IF OCXFile = ? THEN
...
END.
ELSE MESSAGE "esspf006b.wrx":U SKIP(1)
...
------------------------------------------------------------------------------*/
  DISPLAY cb-estado cb-status fi-dt-movto-ini fi-dt-movto-fim fi-chave edLog 
      WITH FRAME f-cad IN WINDOW w-livre.
  ENABLE bt-rel rt-button RECT-4 IMAGE-7 IMAGE-8 bt-rep cb-estado cb-status 
         fi-dt-movto-ini fi-dt-movto-fim fi-chave bt-pesquisar br-imp br-exp 
         br-log edLog 
      WITH FRAME f-cad IN WINDOW w-livre.
...
{utp/ut9000.i "esspf006" "2.09.00.004"}
  ...
  ASSIGN fi-dt-movto-ini:SCREEN-VALUE IN FRAME {&FRAME-NAME} = STRING(TODAY  - 30,"99/99/9999").
  ASSIGN fi-dt-movto-fim:SCREEN-VALUE IN FRAME {&FRAME-NAME} = STRING(TODAY,"99/99/9999").

  cb-status:SCREEN-VALUE = "2".
