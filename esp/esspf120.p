...
ASSIGN c-erro = "".
    ...
    IF NOT AVAIL es-api-export-spf THEN DO:
        ...
        RETURN "NOK".
    END.
    IF es-api-export-spf.chave = "" THEN DO:
    ...
    IF ENTRY(1,es-api-export-spf.chave,"|") = "Faturamento" OR
       ENTRY(1,es-api-export-spf.chave,"|") = "Cancelamento"  THEN DO:
    ...
    END.
    IF ENTRY(1,es-api-export-spf.chave,"|") = "Cancelamento Pedido" OR
       ENTRY(1,es-api-export-spf.chave,"|") = "Altera‡Æo Pedido"  THEN DO:
...
/*     END.                                                                                                  */
    ...
    ASSIGN es-api-export-spf.c-json             = c-Json
...
PROCEDURE piGravaTempitensNota:
    ...
    ASSIGN  pOper         = ENTRY(1,es-api-export-spf.chave,"|")
            pcod-estabel  = ENTRY(2,es-api-export-spf.chave,"|")
            pserie        = ENTRY(3,es-api-export-spf.chave,"|")
            pnr-nota-fis  = ENTRY(4,es-api-export-spf.chave,"|").
    ...
    IF NOT AVAIL nota-fiscal THEN DO:
        ...
        pErro = SUBSTITUTE("Nota  nÆo encontrado (&1)", es-api-export-spf.chave ).      
        RETURN "NOK".                                                              
    ...
    ASSIGN tt-req.operacao     = pOper
           ...
           tt-req.data         = es-api-export-spf.data-movto
        .
...
PROCEDURE piGravaTempitensPedido:
    ...
    ASSIGN  pOper       = ENTRY(1,es-api-export-spf.chave,"|")
            pnomeAbrev  = ENTRY(2,es-api-export-spf.chave,"|")
            pnrPedcli   = ENTRY(3,es-api-export-spf.chave,"|")
            pseq        = INT(ENTRY(4,es-api-export-spf.chave,"|"))
            pitem       = ENTRY(5,es-api-export-spf.chave,"|").

    IF pOper = "Cancelamento" THEN 
       ASSIGN pOper = TRIM(pOper) + " do Pedido".


    IF NUM-ENTRIES(es-api-export-spf.chave,"|") >= 6 THEN
        ASSIGN  deQuantidade     = DEC(ENTRY(6,es-api-export-spf.chave,"|")).
    ELSE
    DO:
