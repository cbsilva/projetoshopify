...
*******************************************************************************/
{include/i-prgvrs.i esint300 9.99.99.999}
...
DEFINE VARIABLE h_esint300-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_esint300-v01 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
    ...
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         ...
         AT COL 1 ROW 1
         SIZE 126.14 BY 12.04 WIDGET-ID 100.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-cadsim ).
       RUN set-position IN h_p-cadsim ( 1.33 , 36.43 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 0,
                     ...
                     Right-to-Left = First-On-Left':U ,
             OUTPUT h_p-exihel ).
       RUN set-position IN h_p-exihel ( 1.33 , 110.57 ) NO-ERROR.
       /* Size in UIB:  ( 1.25 , 16.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esint300-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esint300-v01 ).
       RUN set-position IN h_esint300-v01 ( 3.00 , 1.00 ) NO-ERROR.
       /* Size in UIB:  ( 9.75 , 125.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esint300-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_esint300-q01 ).
       RUN set-position IN h_esint300-q01 ( 1.21 , 67.14 ) NO-ERROR.
       /* Size in UIB:  ( 1.50 , 7.00 ) */

       /* Links to SmartPanel h_p-exihel. */
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'State':U , h_p-exihel ).

       /* Links to SmartViewer h_esint300-v01. */
       RUN add-link IN adm-broker-hdl ( h_esint300-q01 , 'Record':U , h_esint300-v01 ).
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'TableIO':U , h_esint300-v01 ).

       /* Links to SmartQuery h_esint300-q01. */
       RUN add-link IN adm-broker-hdl ( h_p-exihel , 'State':U , h_esint300-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'Navigation':U , h_esint300-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'State':U , h_esint300-q01 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-exihel ,
             h_p-cadsim , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_esint300-v01 ,
             h_p-exihel , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "esint300" "9.99.99.999"}
