...
DO:
FIND es-api-param-acr NO-LOCK
    WHERE es-api-param-acr.cod_empresa EQ INPUT FRAME {&FRAME-NAME} c_cod_empresa
      AND es-api-param-acr.cod_estab EQ INPUT FRAME {&FRAME-NAME} c_cod_estab NO-ERROR.

IF NOT AVAILABLE es-api-param-acr THEN DO:
    {utp/ut-table.i mgesp es-api-param-acr 1}
    RUN utp/ut-msgs.p(INPUT "show",
                      INPUT 2,
                      INPUT RETURN-VALUE).
    RETURN NO-APPLY.
END.
ASSIGN p-row-tabela = ROWID(es-api-param-acr).
END.
