...
*******************************************************************************/
{include/i-prgvrs.i esspf018 12.00.00.001}
...
DEFINE VARIABLE h_esspf018q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_esspf018v01 AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esspf018v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esspf018v01 ).
       RUN set-position IN h_esspf018v01 ( 2.75 , 1.43 ) NO-ERROR.
       /* Size in UIB:  ( 10.00 , 88.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esspf018q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'ProgPesquisa = esp\esspf018z01.w,
                     ProgVaPara = esp\esspf018g01.w,
                     ProgIncMod = ,
                     Implantar = no':U ,
             OUTPUT h_esspf018q01 ).
       RUN set-position IN h_esspf018q01 ( 1.25 , 59.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.00 , 7.00 ) */

       /* Links to SmartPanel h_p-exihel. */
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'State':U , h_p-exihel ).

       /* Links to SmartViewer h_esspf018v01. */
       RUN add-link IN adm-broker-hdl ( h_esspf018q01 , 'Record':U , h_esspf018v01 ).
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'TableIO':U , h_esspf018v01 ).

       /* Links to SmartQuery h_esspf018q01. */
       RUN add-link IN adm-broker-hdl ( h_p-exihel , 'State':U , h_esspf018q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'Navigation':U , h_esspf018q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'State':U , h_esspf018q01 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-exihel ,
             h_p-cadsim , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_esspf018v01 ,
             h_p-exihel , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "esspf018" "12.00.00.001"}
