...
*******************************************************************************/
{include/i-prgvrs.i ESSPF019 9.99.99.999}
...
DEFINE VARIABLE h_esspf019q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_esspf019v01-2 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
    ...
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         ...
         AT COL 1 ROW 1
         SIZE 103.57 BY 19.75 WIDGET-ID 100.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-cadsim ).
       RUN set-position IN h_p-cadsim ( 1.33 , 28.57 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 0,
                     ...
                     Right-to-Left = First-On-Left':U ,
             OUTPUT h_p-exihel ).
       RUN set-position IN h_p-exihel ( 1.33 , 86.57 ) NO-ERROR.
       /* Size in UIB:  ( 1.25 , 16.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esspf019v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esspf019v01-2 ).
       RUN set-position IN h_esspf019v01-2 ( 3.25 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 17.50 , 101.72 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esspf019q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'ProgPesquisa = esp/esspf019z01.w,
                     ProgVaPara = esp/esspf019g01.w,
                     ProgIncMod = ,
                     Implantar = no':U ,
             OUTPUT h_esspf019q01 ).
       RUN set-position IN h_esspf019q01 ( 1.25 , 67.29 ) NO-ERROR.
       /* Size in UIB:  ( 1.50 , 8.29 ) */

       /* Links to SmartPanel h_p-exihel. */
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'State':U , h_p-exihel ).

       /* Links to SmartViewer h_esspf019v01-2. */
       RUN add-link IN adm-broker-hdl ( h_esspf019q01 , 'Record':U , h_esspf019v01-2 ).
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'TableIO':U , h_esspf019v01-2 ).

       /* Links to SmartQuery h_esspf019q01. */
       RUN add-link IN adm-broker-hdl ( h_p-exihel , 'State':U , h_esspf019q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'Navigation':U , h_esspf019q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'State':U , h_esspf019q01 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-exihel ,
             h_p-cadsim , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_esspf019v01-2 ,
             h_p-exihel , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESSPF019" "9.99.99.999"}
