...
DEFINE BUFFER b-es-api-param-cliente    FOR es-api-param-cliente.
...
es-api-param-cliente.tp-rec-padrao ~
es-api-param-cliente.cod-cond-pag es-api-param-cliente.cod-transp ~
es-api-param-cliente.cod-gr-cli ~
es-api-param-cliente.cod-gr-cli-fisica ~
es-api-param-cliente.cod-canal-venda ~
es-api-param-cliente.nat-operacao es-api-param-cliente.perc-fat-ped ~
es-api-param-cliente.nat-ope-ext es-api-param-cliente.ins-banc ~
es-api-param-cliente.mod-prefer ~
es-api-param-cliente.log-optan-suspens-ipi ~
es-api-param-cliente.emite-bloq ~
es-api-param-cliente.agente-retencao ~
...
"Nota Promiss¢ria", 9
     ...
     es-api-param-cliente.cod-gr-cli-fisica AT ROW 8.75 COL 25.86 COLON-ALIGNED NO-LABEL WIDGET-ID 150
          VIEW-AS FILL-IN 
          SIZE 8 BY .88
     fi-det-9 AT ROW 8.75 COL 34.14 COLON-ALIGNED NO-LABEL WIDGET-ID 142
     es-api-param-cliente.cod-canal-venda AT ROW 9.67 COL 25.86 COLON-ALIGNED WIDGET-ID 152
          VIEW-AS FILL-IN 
          SIZE 8 BY .88
     fi-det-10 AT ROW 9.67 COL 34.14 COLON-ALIGNED NO-LABEL WIDGET-ID 148
     es-api-param-cliente.nat-operacao AT ROW 10.63 COL 25.86 COLON-ALIGNED WIDGET-ID 52
          LABEL "Natureza Operaá∆o"
          VIEW-AS FILL-IN 
          SIZE 10.14 BY .88
     es-api-param-cliente.perc-fat-ped AT ROW 10.63 COL 68.29 COLON-ALIGNED WIDGET-ID 60
          VIEW-AS FILL-IN 
          SIZE 4.57 BY .88
     es-api-param-cliente.nat-ope-ext AT ROW 11.58 COL 25.86 COLON-ALIGNED WIDGET-ID 50
          VIEW-AS FILL-IN 
          SIZE 10.14 BY .88
     es-api-param-cliente.ins-banc AT ROW 11.58 COL 68.29 COLON-ALIGNED NO-LABEL WIDGET-ID 138
          VIEW-AS FILL-IN 
          SIZE 4.57 BY .88
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-livre ASSIGN
         HIDDEN             = YES
         TITLE              = "ParÉmetro Integraá∆o Clientes"
         HEIGHT             = 19.75
         WIDTH              = 106.29
         MAX-HEIGHT         = 27.21
         MAX-WIDTH          = 133
...
/* SETTINGS FOR FRAME f-cad
   FRAME-NAME L-To-R                                                    */
/* SETTINGS FOR TOGGLE-BOX es-api-param-cliente.agente-retencao IN FRAME f-cad
   EXP-LABEL                                                            */
/* SETTINGS FOR FILL-IN es-api-param-cliente.cod-cond-pag IN FRAME f-cad
   EXP-LABEL                                                            */
/* SETTINGS FOR FILL-IN es-api-param-cliente.cod-transp IN FRAME f-cad
   EXP-LABEL                                                            */
...
/* SETTINGS FOR FILL-IN fi-det-9 IN FRAME f-cad
   NO-ENABLE                                                            */
/* SETTINGS FOR TOGGLE-BOX es-api-param-cliente.log-optan-suspens-ipi IN FRAME f-cad
   EXP-LABEL                                                            */
/* SETTINGS FOR FILL-IN es-api-param-cliente.nat-operacao IN FRAME f-cad
   EXP-LABEL                                                            */
/* SETTINGS FOR FILL-IN es-api-param-cliente.tp-rec-padrao IN FRAME f-cad
   EXP-LABEL                                                            */
...
ON END-ERROR OF w-livre /* ParÉmetro Integraá∆o Clientes */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-livre w-livre
ON WINDOW-CLOSE OF w-livre /* ParÉmetro Integraá∆o Clientes */
DO:
...
DO:
    ...
    ASSIGN FRAME {&FRAME-NAME}
        ...
        es-api-param-cliente.mod-prefer es-api-param-cliente.modalidade es-api-param-cliente.cod-gr-cli-fisica
        ...
        es-api-param-cliente.log-optan-suspens-ipi es-api-param-cliente.cod-canal-venda. 
...
&Scoped-define SELF-NAME es-api-param-cliente.cod-canal-venda
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL es-api-param-cliente.cod-canal-venda w-livre
ON F5 OF es-api-param-cliente.cod-canal-venda IN FRAME f-cad /* Canal de Venda */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL es-api-param-cliente.cod-canal-venda w-livre
ON LEAVE OF es-api-param-cliente.cod-canal-venda IN FRAME f-cad /* Canal de Venda */
DO:
  
    FIND FIRST canal-venda WHERE canal-venda.cod-canal-venda = input frame {&frame-name} es-api-param-cliente.cod-canal-venda NO-LOCK NO-ERROR.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL es-api-param-cliente.cod-canal-venda w-livre
ON MOUSE-SELECT-DOWN OF es-api-param-cliente.cod-canal-venda IN FRAME f-cad /* Canal de Venda */
DO:
  
    APPLY 'F5' TO es-api-param-cliente.cod-canal-venda.
...
&Scoped-define SELF-NAME es-api-param-cliente.cod-gr-cli-fisica
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL es-api-param-cliente.cod-gr-cli-fisica w-livre
ON F5 OF es-api-param-cliente.cod-gr-cli-fisica IN FRAME f-cad /* Gr Fisica */
DO:
  
    assign l-implanta = yes.
    {include/zoomvar.i &prog-zoom="adzoom/z01ad129.w"
                       &campo=es-api-param-cliente.cod-gr-cli-fisica
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL es-api-param-cliente.cod-gr-cli-fisica w-livre
ON LEAVE OF es-api-param-cliente.cod-gr-cli-fisica IN FRAME f-cad /* Gr Fisica */
DO:
  
    FIND FIRST gr-cli WHERE gr-cli.cod-gr-cli = input frame {&frame-name} es-api-param-cliente.cod-gr-cli-fisica NO-LOCK NO-ERROR.
    IF AVAIL gr-cli THEN
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL es-api-param-cliente.cod-gr-cli-fisica w-livre
ON MOUSE-SELECT-DBLCLICK OF es-api-param-cliente.cod-gr-cli-fisica IN FRAME f-cad /* Gr Fisica */
DO:
  
    APPLY 'F5' TO es-api-param-cliente.cod-gr-cli-fisica.
...
es-api-param-cliente.cod-gr-cli-fisica:LOAD-MOUSE-POINTER   ('image/lupa.cur') in frame {&frame-name}.  
...
es-api-param-cliente.cod-canal-venda:load-mouse-pointer     ('image/lupa.cur') in frame {&frame-name}.
...
------------------------------------------------------------------------------*/
  ...
  IF AVAILABLE es-api-param-cliente THEN 
    DISPLAY es-api-param-cliente.portador es-api-param-cliente.modalidade 
          es-api-param-cliente.port-prefer 
          es-api-param-cliente.tp-rec-padrao 
          es-api-param-cliente.cod-cond-pag 
          es-api-param-cliente.cod-transp 
          es-api-param-cliente.cod-gr-cli 
          es-api-param-cliente.cod-gr-cli-fisica 
          es-api-param-cliente.cod-canal-venda 
          es-api-param-cliente.nat-operacao 
          es-api-param-cliente.perc-fat-ped 
          es-api-param-cliente.nat-ope-ext es-api-param-cliente.ins-banc 
          es-api-param-cliente.mod-prefer 
          es-api-param-cliente.log-optan-suspens-ipi 
          es-api-param-cliente.emite-bloq 
          ...
          es-api-param-cliente.ind-fat-par 
          es-api-param-cliente.log-calcula-pis-cofins-unid 
          es-api-param-cliente.log-nf-eletro 
          es-api-param-cliente.natureza 
          es-api-param-cliente.esp-pd-venda 
      WITH FRAME f-cad IN WINDOW w-livre.
  ENABLE bt-alterar bt-salvar rt-button RECT-14 RECT-18 RECT-22 RECT-23 RECT-24 
         RECT-25 es-api-param-cliente.portador 
         es-api-param-cliente.modalidade 
         es-api-param-cliente.port-prefer 
         es-api-param-cliente.tp-rec-padrao 
         es-api-param-cliente.cod-cond-pag 
         es-api-param-cliente.cod-transp 
...
DISABLE es-api-param-cliente.agente-retencao es-api-param-cliente.cod-cond-pag 
      es-api-param-cliente.cod-gr-cli es-api-param-cliente.cod-gr-cli-fisica es-api-param-cliente.ins-banc es-api-param-cliente.cod-transp es-api-param-cliente.emite-bloq 
      es-api-param-cliente.esp-pd-venda es-api-param-cliente.ind-fat-par es-api-param-cliente.log-calcula-pis-cofins-unid 
      es-api-param-cliente.log-nf-eletro es-api-param-cliente.mod-prefer es-api-param-cliente.cod-canal-venda     
      ...
      es-api-param-cliente.portador es-api-param-cliente.tp-rec-padrao es-api-param-cliente.log-optan-suspens-ipi /*sl-cod-gr-c-e*/ WITH FRAME {&FRAME-NAME}.
...
APPLY 'leave' TO es-api-param-cliente.cod-gr-cli-fisica.
APPLY 'leave' TO es-api-param-cliente.ins-banc.
APPLY 'leave' TO es-api-param-cliente.cod-canal-venda.
