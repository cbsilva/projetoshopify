...
ON F5 OF es-api-param-cliente.cod-cond-pag IN FRAME f-cad /* Condi‡Æo Pagamento */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL es-api-param-cliente.cod-cond-pag w-livre
ON LEAVE OF es-api-param-cliente.cod-cond-pag IN FRAME f-cad /* Condi‡Æo Pagamento */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL es-api-param-cliente.cod-cond-pag w-livre
ON MOUSE-SELECT-DBLCLICK OF es-api-param-cliente.cod-cond-pag IN FRAME f-cad /* Condi‡Æo Pagamento */
DO:
...
&Scoped-define SELF-NAME es-api-param-cliente.cod-gr-for
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL es-api-param-cliente.cod-gr-for w-livre
ON LEAVE OF es-api-param-cliente.cod-gr-for IN FRAME f-cad /* Gr Forn */
DO:
...
ON F5 OF es-api-param-cliente.cod-transp IN FRAME f-cad /* Transportador PadrÆo */
DO:
  assign l-implanta = yes.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL es-api-param-cliente.cod-transp w-livre
ON LEAVE OF es-api-param-cliente.cod-transp IN FRAME f-cad /* Transportador PadrÆo */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL es-api-param-cliente.cod-transp w-livre
ON MOUSE-SELECT-DBLCLICK OF es-api-param-cliente.cod-transp IN FRAME f-cad /* Transportador PadrÆo */
DO:
...
ON F5 OF es-api-param-cliente.nat-operacao IN FRAME f-cad /* Natureza Opera‡Æo */
DO:
    assign l-implanta = yes.
  {include/zoomvar.i &prog-zoom="inzoom/z01in245.w"
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL es-api-param-cliente.nat-operacao w-livre
ON MOUSE-SELECT-DBLCLICK OF es-api-param-cliente.nat-operacao IN FRAME f-cad /* Natureza Opera‡Æo */
DO:
...
ON F5 OF es-api-param-cliente.tp-rec-padrao IN FRAME f-cad /* Receita PadrÆo */
DO:
  assign l-implanta = yes.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL es-api-param-cliente.tp-rec-padrao w-livre
ON LEAVE OF es-api-param-cliente.tp-rec-padrao IN FRAME f-cad /* Receita PadrÆo */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL es-api-param-cliente.tp-rec-padrao w-livre
ON MOUSE-SELECT-DBLCLICK OF es-api-param-cliente.tp-rec-padrao IN FRAME f-cad /* Receita PadrÆo */
DO:
...
------------------------------------------------------------------------------*/
  ...
  ENABLE bt-alterar rt-button RECT-14 RECT-18 RECT-22 RECT-23 RECT-24 RECT-25 
         es-api-param-cliente.portador es-api-param-cliente.modalidade 
         es-api-param-cliente.port-prefer es-api-param-cliente.tp-rec-padrao 
         es-api-param-cliente.cod-cond-pag es-api-param-cliente.cod-transp 
         es-api-param-cliente.cod-gr-cli es-api-param-cliente.cod-gr-for 
         es-api-param-cliente.nat-operacao es-api-param-cliente.perc-fat-ped 
         es-api-param-cliente.nat-ope-ext es-api-param-cliente.ins-banc 
         es-api-param-cliente.mod-prefer bt-salvar 
         es-api-param-cliente.log-optan-suspens-ipi 
         es-api-param-cliente.emite-bloq es-api-param-cliente.agente-retencao 
         es-api-param-cliente.ind-fat-par 
         es-api-param-cliente.log-calcula-pis-cofins-unid 
