...
*******************************************************************************/
{include/i-prgvrs.i esint017 1.00.00.000}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i esint017 <m¢dulo>}
&ENDIF
...
DEFINE BUFFER b-es-api-param-ped    FOR es-api-param-ped.
...
&Scoped-Define ENABLED-FIELDS es-api-param-ped.cod-estabel ~
es-api-param-ped.mo-codigo 
&Scoped-define ENABLED-TABLES es-api-param-ped
&Scoped-define FIRST-ENABLED-TABLE es-api-param-ped
&Scoped-Define ENABLED-OBJECTS bt-alterar rt-button RECT-23 bt-salvar 
&Scoped-Define DISPLAYED-FIELDS es-api-param-ped.cod-estabel ~
es-api-param-ped.mo-codigo 
&Scoped-define DISPLAYED-TABLES es-api-param-ped
&Scoped-define FIRST-DISPLAYED-TABLE es-api-param-ped
...
DEFINE FRAME f-cad
     ...
     es-api-param-ped.cod-estabel AT ROW 3 COL 25.86 COLON-ALIGNED WIDGET-ID 154
          VIEW-AS FILL-IN 
          SIZE 6.86 BY .88
     fi-det-1 AT ROW 3 COL 32.86 COLON-ALIGNED NO-LABEL WIDGET-ID 90
     es-api-param-ped.mo-codigo AT ROW 4 COL 25.86 COLON-ALIGNED WIDGET-ID 156
          VIEW-AS FILL-IN 
          SIZE 6.86 BY .88
...
DO:
    ...
    IF NOT AVAIL es-api-param-ped THEN
        CREATE es-api-param-ped.

    ASSIGN FRAME {&FRAME-NAME}
        es-api-param-ped.cod-estabel es-api-param-ped.mo-codigo. 
...
&Scoped-define SELF-NAME es-api-param-ped.cod-estabel
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL es-api-param-ped.cod-estabel w-livre
ON F5 OF es-api-param-ped.cod-estabel IN FRAME f-cad /* Estabelecimento */
DO:
  
    ASSIGN l-implanta = yes.
    {include/zoomvar.i &prog-zoom="inzoom/z01in661.w"
                       &campo=es-api-param-ped.cod-estabel
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL es-api-param-ped.cod-estabel w-livre
ON LEAVE OF es-api-param-ped.cod-estabel IN FRAME f-cad /* Estabelecimento */
DO:
  
    FIND FIRST estabelec WHERE estabelec.cod-estabel = input frame {&frame-name} es-api-param-ped.cod-estabel NO-LOCK NO-ERROR.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL es-api-param-ped.cod-estabel w-livre
ON MOUSE-SELECT-DOWN OF es-api-param-ped.cod-estabel IN FRAME f-cad /* Estabelecimento */
DO:
  
    APPLY 'F5' TO es-api-param-ped.cod-estabel.
...
&Scoped-define SELF-NAME es-api-param-ped.mo-codigo
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL es-api-param-ped.mo-codigo w-livre
ON F5 OF es-api-param-ped.mo-codigo IN FRAME f-cad /* Moeda */
DO:
  
    ASSIGN l-implanta = yes.
    {include/zoomvar.i &prog-zoom="adzoom/z01ad178.w"
                       &campo=es-api-param-ped.mo-codigo
                       &campozoom=mo-codigo}
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL es-api-param-ped.mo-codigo w-livre
ON LEAVE OF es-api-param-ped.mo-codigo IN FRAME f-cad /* Moeda */
DO:
  
    FIND FIRST moeda WHERE moeda.mo-codigo = input frame {&frame-name} es-api-param-ped.mo-codigo NO-LOCK NO-ERROR.
    IF AVAIL moeda THEN
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL es-api-param-ped.mo-codigo w-livre
ON MOUSE-SELECT-DOWN OF es-api-param-ped.mo-codigo IN FRAME f-cad /* Moeda */
DO:
  
    APPLY 'F5' TO es-api-param-ped.mo-codigo.
...
es-api-param-ped.cod-estabel:load-mouse-pointer ('image/lupa.cur') in frame {&frame-name}.  
es-api-param-ped.mo-codigo:load-mouse-pointer   ('image/lupa.cur') in frame {&frame-name}.
...
------------------------------------------------------------------------------*/
  ...
  IF AVAILABLE es-api-param-ped THEN 
    DISPLAY es-api-param-ped.cod-estabel es-api-param-ped.mo-codigo 
      WITH FRAME f-cad IN WINDOW w-livre.
  ENABLE bt-alterar rt-button RECT-23 es-api-param-ped.cod-estabel 
         es-api-param-ped.mo-codigo bt-salvar 
      WITH FRAME f-cad IN WINDOW w-livre.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "esint017" "1.00.00.000"}
...
DISABLE es-api-param-ped.cod-estabel es-api-param-ped.mo-codigo WITH FRAME {&FRAME-NAME}.
...
ENABLE es-api-param-ped.cod-estabel es-api-param-ped.mo-codigo  WITH FRAME {&FRAME-NAME}.
...
FIND FIRST es-api-param-ped NO-ERROR.
IF NOT AVAIL es-api-param-ped THEN DO:
    CREATE es-api-param-ped.
    ASSIGN FRAME {&FRAME-NAME} es-api-param-ped.cod-estabel es-api-param-ped.mo-codigo.
END.

DISP es-api-param-ped.cod-estabel es-api-param-ped.mo-codigo WITH FRAME {&FRAME-NAME}.

APPLY 'leave' TO es-api-param-ped.cod-estabel.
APPLY 'leave' TO es-api-param-ped.mo-codigo.
