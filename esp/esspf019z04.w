...
DEFINE VARIABLE h_esspf019b04 AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esspf019b04.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esspf019b04 ).
       RUN set-position IN h_esspf019b04 ( 3.00 , 4.00 ) NO-ERROR.
       /* Size in UIB:  ( 10.17 , 80.14 ) */

       /* Links to SmartBrowser h_esspf019b04. */
       RUN add-link IN adm-broker-hdl ( h_esspf019b04 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_esspf019b04 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
