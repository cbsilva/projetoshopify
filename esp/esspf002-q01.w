...
*******************************************************************************/
{include/i-prgvrs.i Q01ESCD0002 12.1.10.001}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i Q01ESCD0002 MUT}
&ENDIF
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH es-api-app-spf NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH es-api-app-spf NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main es-api-app-spf
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main es-api-app-spf
