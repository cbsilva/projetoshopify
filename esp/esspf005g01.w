...
*******************************************************************************/
{include/i-prgvrs.i esspf005g01 12.00.00.001}
...
DO:
FIND es_notificacoes NO-LOCK
    WHERE es_notificacoes.cod_mensagem EQ INPUT FRAME {&FRAME-NAME} i_cod_mensagem NO-ERROR.

IF NOT AVAILABLE es_notificacoes THEN DO:
    {utp/ut-table.i movmac es_notificacoes 1}
    RUN utp/ut-msgs.p(INPUT "show",
                      INPUT 2,
                      INPUT RETURN-VALUE).
    RETURN NO-APPLY.
END.
ASSIGN p-row-tabela = ROWID(es_notificacoes).
END.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "esspf005g01" "12.00.00.001"}
