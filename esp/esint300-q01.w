...
&Scoped-define INTERNAL-TABLES es-api-token-param

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH es-api-token-param NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH es-api-token-param NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main es-api-token-param
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main es-api-token-param
...
<FOREIGN-KEYS>
cod-usuario||y|movmac.es-api-token-param.cod-usuario
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "movmac.es-api-token-param"
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "cod-usuario" "es-api-token-param" "cod-usuario"}
