...
ON F5 OF es-api-param-cliente-spf.cod-cond-pag IN FRAME f-cad /* Condiá∆o Pagamento */
DO:
  assign l-implanta = yes.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL es-api-param-cliente-spf.cod-cond-pag w-livre
ON LEAVE OF es-api-param-cliente-spf.cod-cond-pag IN FRAME f-cad /* Condiá∆o Pagamento */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL es-api-param-cliente-spf.cod-cond-pag w-livre
ON MOUSE-SELECT-DBLCLICK OF es-api-param-cliente-spf.cod-cond-pag IN FRAME f-cad /* Condiá∆o Pagamento */
DO:
...
ON F5 OF es-api-param-cliente-spf.cod-transp IN FRAME f-cad /* Transportador Padr∆o */
DO:
  assign l-implanta = yes.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL es-api-param-cliente-spf.cod-transp w-livre
ON LEAVE OF es-api-param-cliente-spf.cod-transp IN FRAME f-cad /* Transportador Padr∆o */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL es-api-param-cliente-spf.cod-transp w-livre
ON MOUSE-SELECT-DBLCLICK OF es-api-param-cliente-spf.cod-transp IN FRAME f-cad /* Transportador Padr∆o */
DO:
...
ON F5 OF es-api-param-cliente-spf.nat-operacao IN FRAME f-cad /* Natureza Operaá∆o */
DO:
    assign l-implanta = yes.
  {include/zoomvar.i &prog-zoom="inzoom/z01in245.w"
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL es-api-param-cliente-spf.nat-operacao w-livre
ON MOUSE-SELECT-DBLCLICK OF es-api-param-cliente-spf.nat-operacao IN FRAME f-cad /* Natureza Operaá∆o */
DO:
