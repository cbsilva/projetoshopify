...
*******************************************************************************/
{include/i-prgvrs.i esint018g01 12.00.00.001}
...
DO:
FIND es-notificacoes NO-LOCK
    WHERE es-notificacoes.cod_mensagem EQ INPUT FRAME {&FRAME-NAME} i_cod_mensagem NO-ERROR.

IF NOT AVAILABLE es-notificacoes THEN DO:
    {utp/ut-table.i movmac es-notificacoes 1}
    RUN utp/ut-msgs.p(INPUT "show",
                      INPUT 2,
                      INPUT RETURN-VALUE).
    RETURN NO-APPLY.
END.
ASSIGN p-row-tabela = ROWID(es-notificacoes).
END.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "esint018g01" "12.00.00.001"}
