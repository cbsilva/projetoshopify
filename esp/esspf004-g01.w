...
*******************************************************************************/
{include/i-prgvrs.i esspf004-G01 2.09.00.000}
...
DO:
    ...
    THEN DO:
        FIND FIRST es-api-param-spf NO-LOCK
             WHERE es-api-param-spf.cd-tipo-integr  EQ INPUT FRAME {&FRAME-NAME} i_cd-tipo-integr
             NO-ERROR.
    END.
    ...
    THEN DO:
        FIND FIRST es-api-param-spf NO-LOCK
             WHERE es-api-param-spf.des-tipo-integr EQ INPUT FRAME {&FRAME-NAME} c_des-tipo-integr 
             NO-ERROR.
    END.

    IF NOT AVAILABLE es-api-param-spf 
    THEN DO:
        {utp/ut-table.i mgcam es-api-param-spf 1}
        RUN utp/ut-msgs.p(INPUT "show",
                          INPUT 2,
                          INPUT RETURN-VALUE).
        RETURN NO-APPLY.
    END.
    ASSIGN p-row-tabela = ROWID(es-api-param-spf).
END.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "esspf004-G01" "12.00.00.000"}
