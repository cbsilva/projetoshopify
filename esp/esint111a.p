...
/*             MESSAGE                                                              */
/*                 "LASF DEBUG"                                                SKIP */
/*                 "es-api-import.id-movto   "    es-api-import.id-movto       SKIP */
/*                 "es-api-import.cod-status "    es-api-import.cod-status     SKIP */
/*                 "es-api-import.chave-alt  "    es-api-import.chave-alt      SKIP */
/*                 VIEW-AS ALERT-BOX INFORMATION BUTTONS OK.                        */

            IF es-api-import.cod-status = 9 THEN
                RETURN "OK".
...
PROCEDURE gerarFilaImportacao:
    ...
    FOR FIRST es-api-import NO-LOCK WHERE
              es-api-import.cd-tipo-integr      = 5
          //AND es-api-import.chave               = pArquivo
          AND es-api-import.chave-alt           = pArquivo
        :
    END.
    ...
    DO:
        ...
        ASSIGN  es-api-import.id-movto          = NEXT-VALUE(seq_import)
                es-api-import.cd-tipo-integr    = 5
                //es-api-import.chave             = pArquivo
                es-api-import.chave-alt         = pArquivo
                ...
                //es-api-import.c-json            = c-nr-pedcli.
                es-api-import.chave             = c-nr-pedcli  + "|" + c-pedido-cli.
    END.
    ELSE
    DO:
        IF es-api-import.cod-status = 9 THEN
        ...
        //ASSIGN  c-nr-pedcli                     = STRING(es-api-import.c-json).
        ASSIGN  c-nr-pedcli                     = ENTRY(1, es-api-import.chave, "|").
...
DEFINE VARIABLE i-nr-seq AS INTEGER NO-UNDO.
    ...
    daAux  = NOW.
    IF NOT AVAIL es-api-import-log OR DATE(es-api-import-log.data-log) <> DATE(daAux) THEN
    DO:
        CREATE es-api-import-log.
        ASSIGN es-api-import-log.cd-tipo-integr = es-api-import.cd-tipo-integr
               es-api-import-log.id-movto       = es-api-import.id-movto      
               es-api-import-log.data-log       = NOW
               es-api-import-log.nr-seq         = i-nr-seq. 
    END.
    ELSE
        FIND CURRENT es-api-import-log EXCLUSIVE-LOCK.
        

    ASSIGN es-api-import-log.des-log        = pMensagem
           es-api-import-log.data-log       = daAux.

/*     CREATE es-api-import-log.                                                                                  */
/*     ASSIGN es-api-import-log.cd-tipo-integr = es-api-import.cd-tipo-integr                                     */
/*            es-api-import-log.id-movto       = es-api-import.id-movto                                           */
/*            es-api-import-log.data-log       = NOW                                                              */
/*            es-api-import-log.des-log        = IF c-erro = "" THEN "Registro integrado com sucesso" ELSE c-erro */
/*            es-api-import-log.nr-seq         = i-nr-seq.                                                        */

    RELEASE es-api-import-log.
...
DEFINE INPUT  PARAMETER pStatus AS CHARACTER   NO-UNDO.
    ...
    FIND CURRENT es-api-import EXCLUSIVE-LOCK.

    IF pStatus = "OK" THEN 
        ASSIGN  es-api-import.data-fim      = NOW
                es-api-import.ind-situacao  = 2
                es-api-import.cod-status    = 1
                // es-api-import.chave         = IF c-chave = "" THEN es-api-import.chave ELSE c-chave
        .

    IF pStatus = "NOK" THEN 
        ASSIGN  es-api-import.data-fim      = NOW
                es-api-import.ind-situacao  = 2
                es-api-import.cod-status    = 2
                // es-api-import.chave         = IF c-chave = "" THEN es-api-import.chave ELSE c-chave
        .
    ...
    FIND CURRENT es-api-import NO-LOCK.
