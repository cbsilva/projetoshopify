...
&Scoped-Define ENABLED-OBJECTS c_cod_empresa rt-button c_cod_estab bt-ok ~
bt-cancela bt-ajuda 
&Scoped-Define DISPLAYED-OBJECTS c_cod_empresa c_cod_estab 
...
DEFINE FRAME d-vapara
     ...
     c_cod_estab AT ROW 2 COL 30 COLON-ALIGNED WIDGET-ID 4
...
DO:
FIND es-api-param-acr-spf NO-LOCK
    WHERE es-api-param-acr-spf.cod_empresa EQ INPUT FRAME {&FRAME-NAME} c_cod_empresa
      AND es-api-param-acr-spf.cod_estab EQ INPUT FRAME {&FRAME-NAME} c_cod_estab NO-ERROR.

IF NOT AVAILABLE es-api-param-acr-spf THEN DO:
    {utp/ut-table.i mgesp es-api-param-acr-spf 1}
    RUN utp/ut-msgs.p(INPUT "show",
                      INPUT 2,
                      INPUT RETURN-VALUE).
    RETURN NO-APPLY.
END.
ASSIGN p-row-tabela = ROWID(es-api-param-acr-spf).
END.
...
------------------------------------------------------------------------------*/
  DISPLAY c_cod_empresa c_cod_estab 
      WITH FRAME d-vapara.
  ENABLE c_cod_empresa rt-button c_cod_estab bt-ok bt-cancela bt-ajuda 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
