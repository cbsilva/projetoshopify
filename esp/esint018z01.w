...
*******************************************************************************/
{include/i-prgvrs.i esint018b01 12.00.00.001}
...
&Scoped-Define ENABLED-OBJECTS rt-button bt-implantar bt-ok bt-ajuda 
...
DEFINE VARIABLE h_esint018b01-3 AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esint018b01.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esint018b01-3 ).
       RUN set-position IN h_esint018b01-3 ( 3.50 , 5.00 ) NO-ERROR.
       /* Size in UIB:  ( 10.17 , 80.14 ) */

       /* Links to SmartBrowser h_esint018b01-3. */
       RUN add-link IN adm-broker-hdl ( h_esint018b01-3 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_esint018b01-3 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
...
------------------------------------------------------------------------------*/
  ENABLE rt-button bt-implantar bt-ok bt-ajuda 
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "esint018b01" "12.00.00.001"}
