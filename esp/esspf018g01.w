...
*******************************************************************************/
{include/i-prgvrs.i esspf018g01 12.00.00.001}
...
&Scoped-Define ENABLED-OBJECTS rt-button i_cod_mensagem bt-ok bt-cancela ~
bt-ajuda 
&Scoped-Define DISPLAYED-OBJECTS i_cod_mensagem 
...
DEFINE VARIABLE i_cod_mensagem AS INTEGER FORMAT ">>>>>9":U INITIAL 0 
...
DEFINE FRAME d-vapara
     i_cod_mensagem AT ROW 2 COL 20 COLON-ALIGNED WIDGET-ID 2
     bt-ok AT ROW 4.5 COL 2.14
     bt-cancela AT ROW 4.5 COL 13
     bt-ajuda AT ROW 4.5 COL 37
...
DO:
FIND es-notificacoes-spf NO-LOCK
    WHERE es-notificacoes-spf.cod_mensagem EQ INPUT FRAME {&FRAME-NAME} i_cod_mensagem NO-ERROR.

IF NOT AVAILABLE es-notificacoes-spf THEN DO:
    {utp/ut-table.i movmac es-notificacoes-spf 1}
    RUN utp/ut-msgs.p(INPUT "show",
                      INPUT 2,
                      INPUT RETURN-VALUE).
    RETURN NO-APPLY.
END.
ASSIGN p-row-tabela = ROWID(es-notificacoes-spf).
END.
...
------------------------------------------------------------------------------*/
  DISPLAY i_cod_mensagem 
      WITH FRAME d-vapara.
  ENABLE rt-button i_cod_mensagem bt-ok bt-cancela bt-ajuda 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "esspf018g01" "12.00.00.001"}
