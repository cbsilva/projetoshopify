...
*******************************************************************************/
{include/i-prgvrs.i ESSPF300 9.99.99.999}
...
DEFINE VARIABLE h_esspf300-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_esspf300-v01 AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esspf300-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esspf300-v01 ).
       RUN set-position IN h_esspf300-v01 ( 3.00 , 1.00 ) NO-ERROR.
       /* Size in UIB:  ( 9.75 , 125.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esspf300-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_esspf300-q01 ).
       RUN set-position IN h_esspf300-q01 ( 1.21 , 67.14 ) NO-ERROR.
       /* Size in UIB:  ( 1.50 , 7.00 ) */

       /* Links to SmartPanel h_p-exihel. */
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'State':U , h_p-exihel ).

       /* Links to SmartViewer h_esspf300-v01. */
       RUN add-link IN adm-broker-hdl ( h_esspf300-q01 , 'Record':U , h_esspf300-v01 ).
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'TableIO':U , h_esspf300-v01 ).

       /* Links to SmartQuery h_esspf300-q01. */
       RUN add-link IN adm-broker-hdl ( h_p-exihel , 'State':U , h_esspf300-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'Navigation':U , h_esspf300-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'State':U , h_esspf300-q01 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-exihel ,
             h_p-cadsim , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_esspf300-v01 ,
             h_p-exihel , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESSPF300" "9.99.99.999"}
