...
*******************************************************************************/
{include/i-prgvrs.i Z01esspf002 12.1.10.001}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i Z01esspf002 MUT}
&ENDIF
...
DEFINE VARIABLE h_b01esspf002 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-zoom
     bt-implantar AT ROW 11.54 COL 1.72
     bt-ajuda AT ROW 12.92 COL 54.29
     bt-ok AT ROW 12.96 COL 2.43
     bt-cancela AT ROW 12.96 COL 13.43
     rt-button AT ROW 12.71 COL 1.43
...
ON END-ERROR OF w-pesquisa /* Pesquisa de Canal */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-pesquisa w-pesquisa
ON WINDOW-CLOSE OF w-pesquisa /* Pesquisa de Canal */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esspf002-b01.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b01esspf002 ).
       RUN set-position IN h_b01esspf002 ( 1.21 , 1.57 ) NO-ERROR.
       /* Size in UIB:  ( 10.17 , 64.00 ) */

       /* Links to SmartBrowser h_b01esspf002. */
       RUN add-link IN adm-broker-hdl ( h_b01esspf002 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b01esspf002 ,
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "Z01esspf002" "12.1.10.001"}
