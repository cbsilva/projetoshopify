...
/*-----------------------------------------------------------
 ...
 ------------------------------------------------------------*/
    ...
    FIND FIRST es-api-param WHERE ROWID(es-api-param) = pRowid NO-LOCK NO-ERROR.
    ...
    FIND FIRST es-api-token-param  
         WHERE es-api-token-param.cod-sistema = es-api-param.cd-sistema 
    NO-LOCK NO-ERROR.
    ...
    ASSIGN cHttpUrl    = es-api-param.host-integr
    ...
    /*-- Quando informado porta no esint004, ‚ acrescentado no parametro --*/
    ...
    oCredentials = new Credentials('Authorization', es-api-token-param.cod-usuario, es-api-token-param.cod-senha ).   
